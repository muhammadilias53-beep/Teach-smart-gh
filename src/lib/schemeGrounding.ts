...
export function formatWeeklyDistributionForPrompt(
  ...
  const lines: string[] = [
    ...
    `3. You are ONLY responsible for completing the RESOURCES column:`,
    `   - Resources / TLRs: Concise, realistic, locally available Ghanaian teaching aids and materials (e.g. manila cards, word cards, realia, charts, sentence strips). Avoid long prose.`,
    `   Do NOT add Learning Outcomes, Activities, Assessment, Core Competencies, or References.`,
