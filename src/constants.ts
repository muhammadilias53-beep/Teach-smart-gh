...
export const MATH_B4_B6_LESSON_FRAMES: Record<string, any> = {
  ...
  "B4.1.2.5.1": {
    ...
    activities: [
      ...
      "Practice dividing 2-digit numbers by 1-digit (e.g., 48 Ã· 4)",
...
export const MATH_B7_LESSON_FRAMES: Record<string, any> = {
  ...
  "B7.1.2.3": {
    topic: "Number Operations â€“ Powers of Numbers",
  ...
  "B7.1.3.1": {
    topic: "Fractions â€“ Comparing Fractions",
  ...
  "B7.3.1.1": {
    topic: "Geometry and Measurement â€“ Angles",
    ...
    activities: [
      ...
      "Apply facts about complementary (90Â°) and supplementary (180Â°) angles",
      "Solve problems using adjacent and vertically opposite angles"
    ],
    resources: ["Protractor", "Ruler", "Geostrips (or straws)", "Geometry sets"]
  },
  "B7.3.2.1": {
    topic: "Measurement â€“ Perimeter of Plane Shapes Including Circles",
    keyWords: ["Perimeter", "Dimension", "Circle", "Diameter", "Pi (Ï€)"],
    activities: [
      "Calculate perimeter using multiple units (e.g., cm and mm)",
      "Measure diameter and circumference of circular objects",
      "Deduce the formula for circumference by observing C Ã· D ratio"
    ],
...
export const SCIENCE_B7_LESSON_FRAMES: Record<string, any> = {
  ...
  "B7.4.1.1": {
    ...
    activities: [
      ...
      "Use PE = mgh and KE = 1/2mvÂ² to solve mechanical energy problems",
...
export const FRENCH_B4_B6_LESSON_FRAMES: Record<string, any> = {
  "B4.1.1.1": {
    topic: "Saluer et prendre congÃ© (Greetings and Leave-taking)",
    keyWords: ["Bonjour", "Au revoir", "Comment vas-tu ?", "Je vais bien", "Ã€ bientÃ´t"],
    activities: [
  ...
  "B4.1.2.1": {
    topic: "Se prÃ©senter (Self-introduction)",
    keyWords: ["Je m'appelle", "Mon nom est", "Je suis ghanÃ©en(ne)", "PrÃ©nom"],
    activities: [
      "Listen to the teacher introducing themselves to the class",
      "Practice saying your name and nationality in French",
      "Complete a simple identity card (fiche d'identitÃ©)",
  ...
  "B4.4.1.1": {
    ...
    keyWords: ["Un", "Deux", "Trois", "Calcul", "Plus", "Ã‰gal"],
    activities: [
      ...
      "Perform simple additions like 'deux plus deux Ã©gal quatre' in French",
      "Sing a numerical rhyme"
    ],
    resources: ["Counters", "Number cards", "Abacus"]
  },
  "B5.1.2.1": {
    topic: "Se prÃ©senter - Ã‚ge et Profession (Introduction - Age and Profession)",
    keyWords: ["J'ai ... ans", "Je suis Ã©lÃ¨ve", "J'habite Ã ", "Quel Ã¢ge as-tu ?"],
    activities: [
  ...
  "B6.1.3.2": {
    topic: "PrÃ©senter quelqu'un (Presenting someone else)",
    keyWords: ["Voici", "Il s'appelle", "Elxœ”WkÚ8ý>¿ÂâKw%hÕÎJ[Í>$†aê@Y˜n?¬ª‘“âŽG¶Í®úß÷Üki:‰€}_çÜs/F	ÿBV•2Fõú¢7z¡|…-…,ôOêçÞ§þ™ÀLƒ^ë •¿ÿð;BôîÊàlV§JH±tZ•™°N¤Fz_È D°"ä*¾!t)®*Ó¼×ßÝÿà•¨tj§<Î”ON`–tk|)[{q“ËRjYŠJ9oKi8œ½µNÃçùàáUàIùÖˆ.W#r2(T‘(·¿8“.èTW2¢¬¤vƒuO¢B\0%ƒF=2-]ÕðÈ÷¶uÁ	[»”ËÒ»F¢y*]æ…]~¦è]G